...
public class MediaPhoneProvider extends ContentProvider {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("INSERT INTO " + FRAMES_LOCATION + " (" + FrameItem.INTERNAL_ID + ", " +
					"" + FrameItem.PARENT_ID + ", " + FrameItem.SEQUENCE_ID + ", " + FrameItem.DATE_CREATED + ") " +
					"VALUES ('" + FrameItem.KEY_FRAME_ID_START + "', null, " + Integer.MIN_VALUE + ", " + 0 + ");");
			db.execSQL("INSERT INTO " + FRAMES_LOCATION + " (" + FrameItem.INTERNAL_ID + ", " +
					"" + FrameItem.PARENT_ID + ", " + FrameItem.SEQUENCE_ID + ", " + FrameItem.DATE_CREATED + ") " +
					"VALUES ('" + FrameItem.KEY_FRAME_ID_END + "', null, " + Integer.MAX_VALUE + ", " +
					"" + Integer.MAX_VALUE + ");");
