...
public class FramesManager {
	...
	public static void reloadFrameIcon(Resources resources, ContentResolver contentResolver, FrameItem frame,
		...
		ImageCacheUtilities.addIconToCache(MediaPhone.DIRECTORY_THUMBS, frameCacheId, frameIcon, cacheTypeContainer.type,
	...
	public static void loadTemporaryFrameIcon(Resources resources, FrameItem frame, boolean addBorder) {
		ImageCacheUtilities.addIconToCache(MediaPhone.DIRECTORY_THUMBS, frame.getCacheId(),
				FrameItem.loadTemporaryIcon(resources, addBorder), MediaPhone.ICON_CACHE_TYPE, MediaPhone.ICON_CACHE_QUALITY);
	}

	public static FrameItem addFrame(Resources resources, ContentResolver contentResolver, FrameItem frame, boolean loadIcon) {
		final Uri uri = contentResolver.insert(FrameItem.CONTENT_URI, frame.getContentValues());
		if (uri != null) {
			if (loadIcon) {
	 ...
	 */
	public static int adjustNarrativeSequenceIds(Resources res, ContentResolver contentResolver, String narrativeId,
