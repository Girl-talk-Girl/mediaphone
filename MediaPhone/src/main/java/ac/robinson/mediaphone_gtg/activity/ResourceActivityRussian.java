...
public class ResourceActivityRussian extends MediaPhoneActivity {
	...
	private static final String sResourceLanguageCode = "ru";
		...
		if (intent != null) {
			...
			RestClient.get(resourceId, sResourceLanguageCode, new TextHttpResponseHandler() {
				...
				public void onSuccess(int statusCode, Header[] headers, String responseString) {
					...
					if (remoteContent != null) { // non-null response means content has been updated
						Snackbar.make(mWebView, R.string.resource_update_available_russian, Snackbar.LENGTH_LONG)
								.setAction(R.string.resource_update_accept_russian, new View.OnClickListener() {
							@Override
			...
			if (!TextUtils.isEmpty(resourceString)) {
				...
				if (!TextUtils.isEmpty(resourceString)) {
					...
					mWebView.loadData(getString(R.string.error_loading_resource_russian), "text/html", "utf-8");
				}
			}
		}
	}
