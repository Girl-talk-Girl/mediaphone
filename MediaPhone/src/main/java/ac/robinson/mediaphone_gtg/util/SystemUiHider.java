...
public abstract class SystemUiHider {
	/**
	 * When this flag is set, the {@link android.view.WindowManager.LayoutParams#FLAG_LAYOUT_IN_SCREEN} flag will be
	 * set
	 * on older devices, making the status bar "float" on top of the activity layout. This is most useful when there
	 * are
	...
	/**
	 * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the status bar. If
	 * there
